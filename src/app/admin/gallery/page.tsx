  ...
  return (
    <>
      ...
      >
        ...
        {/* Filter Cerdas Panel */}
        <motion.div variants={fadeInUp} className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#B88E52] focus:ring-1 focus:ring-[#B88E52] transition-all"
              />
            </div>

            {/* 2. Destination/Category Dropdown */}
            <select
              value={filterCategory}
              onChange={(e) => setFilterCategory(e.target.value)}
              className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#B88E52] focus:ring-1 focus:ring-[#B88E52] transition-all appearance-none cursor-pointer"
            ...
            <select
              ...
              style={{ backgroundImage: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 20 20'%3e%3cpath stroke='%236b7280' stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M6 8l4 4 4-4'/%3e%3c/svg%3e")`, backgroundPosition: `right .5rem center`, backgroundRepeat: `no-repeat`, backgroundSize: `1.5em 1.5em` }}
            >
              <option value="all">All Voyages (Trips)</option>
        ...
        {isLoading ? (
          <div className="py-20 flex flex-col items-center justify-center text-gray-400 bg-white rounded-3xl border border-gray-100">
                ...
                >
                  ...
                  {viewMode === 'grid' ? (
                    ...
                    <>
                      ...
                      {/* Actions (List) */}
                      <div className="shrink-0 px-2 md:px-4 border-l border-gray-100 flex items-center justify-center">
                        <button 
                          onClick={() => confirmDelete(media)}
