...
export default function BoatDetailsPage() {
  ...
  // Agar kita bisa memanggilnya di 2 tempat berbeda (Desktop & Mobile) tanpa menulis kode 2 kali
  const DestinationsGallery = ({ className = "" }) => (
    ...
    >
      ...
      <div className="col-span-1 row-span-1 rounded-[1.5rem] md:rounded-[2rem] overflow-hidden shadow-xl group relative h-full">
        ...
        <div className="absolute bottom-4 left-4 md:bottom-5 md:left-5 text-white font-bold tracking-wide text-sm md:text-lg lg:text-xl">Komodo Park</div>
      </div>
      ...
      <div className="col-span-1 row-span-1 rounded-[1.5rem] md:rounded-[2rem] overflow-hidden shadow-xl group relative h-full">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#0f172a]/80 to-transparent opacity-70 md:opacity-80"></div>
        <div className="absolute bottom-4 left-4 md:bottom-5 md:left-5 text-white font-bold tracking-wide text-sm md:text-lg lg:text-xl">Pink Beach</div>
      </div>
      ...
      <div className="col-span-2 row-span-1 rounded-[1.5rem] md:rounded-[2rem] overflow-hidden shadow-xl group relative h-full">
        ...
        <div className="absolute bottom-4 left-4 md:bottom-6 md:left-6 text-white font-bold tracking-wide text-lg md:text-2xl lg:text-3xl">Padar Island</div>
      </div>
    </motion.div>
  );
    ...
    <main className="flex flex-col w-full bg-[#f8f9fa] overflow-x-hidden">
      ...
      <section className="relative pt-28 pb-40 md:pt-40 md:pb-56 lg:pt-48 lg:pb-64 bg-[#0f172a] overflow-hidden flex flex-col items-center text-center px-5 border-b border-white/10">
        ...
        >
          ...
          <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-4 md:mb-6 tracking-tight leading-[1.15] drop-shadow-xl px-2">
            KM Pulau Mas 88
          </motion.h1>
          ...
          >
            ...
            <div className="absolute bottom-4 left-4 right-4 md:bottom-8 md:left-8 md:right-8 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl md:rounded-[2rem] p-4 md:p-8 grid grid-cols-2 md:grid-cols-4 gap-y-4 md:gap-0 text-white shadow-2xl">
              <div className="text-center md:border-r border-white/10">
                 <span className="block text-[#B88E52] text-[10px] md:text-xs font-bold uppercase tracking-wider mb-0.5 md:mb-1">Capacity</span>
                 <span className="text-lg sm:text-xl md:text-3xl font-bold tracking-tight">46 Pax</span>
              </div>
              <div className="text-center md:border-r border-white/10">
                 <span className="block text-[#B88E52] text-[10px] md:text-xs font-bold uppercase tracking-wider mb-0.5 md:mb-1">Crew</span>
                 <span className="text-lg sm:text-xl md:text-3xl font-bold tracking-tight">8 Pro</span>
              </div>
              <div className="text-center md:border-r border-white/10">
                 <span className="block text-[#B88E52] text-[10px] md:text-xs font-bold uppercase tracking-wider mb-0.5 md:mb-1">Vessel Type</span>
                 <span className="text-lg sm:text-xl md:text-3xl font-bold tracking-tight">Phinisi</span>
              </div>
              <div className="text-center">
                 <span className="block text-[#B88E52] text-[10px] md:text-xs font-bold uppercase tracking-wider mb-0.5 md:mb-1">Navigation</span>
                 <span className="text-lg sm:text-xl md:text-3xl font-bold tracking-tight">GPS/Radar</span>
              </div>
            </div>
          </motion.div>
        </section>
        ...
        <section className="py-16 md:py-24 lg:py-32 px-5 md:px-6 lg:px-12 relative z-10">
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 md:gap-12 lg:gap-16 items-start relative z-10">
            ...
            <div className="w-full lg:w-1/2 flex flex-col">
              ...
              >
                <span className="text-[#B88E52] font-semibold tracking-wider uppercase text-xs md:text-sm mb-2 md:mb-3 block">The Experience</span>
              ...
              >
                <p className="text-gray-600 text-base md:text-lg leading-relaxed">
                  Experience the untamed beauty of Komodo National Park with an affordable yet premium sailing trip aboard <strong className="text-[#0f172a]">KM Pulau Mas 88</strong>. We bridge the gap between backpacker adventure and essential comfort.
                </p>
                <p className="text-gray-600 text-base md:text-lg leading-relaxed">
      ...
      <section className="py-16 md:py-24 px-5 md:px-6 lg:px-12 bg-white border-y border-gray-100 relative">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 md:gap-16 relative z-10">
          ...
          >
            <span className="text-[#B88E52] font-semibold tracking-wider uppercase text-xs md:text-sm mb-2 md:mb-3 block flex items-center gap-2">
              <CheckCircle2 className="w-4 h-4" /> Vessel Details
            </span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#0f172a] mb-4 md:mb-6 leading-tight">Cruise <br className="hidden lg:block"/> Facilities</h2>
          ...
          {/* Right Side: Specs List (Horizontal Scroll di Mobile, Grid di Desktop) */}
          <motion.div 
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, margin: "-50px" }}
            ...
            {specifications.map((spec, index) => (
              ...
              >
                <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-5">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-[#0f172a]">{spec.title}</h3>
                </div>
      ...
      {/* 5. TECHNICAL DRAWINGS (DARK ARCHITECTURAL THEME - Horizontal Scroll on Mobile) */}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="mb-10 md:mb-16 lg:flex justify-between items-end gap-8">
            <div className="max-w-3xl">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 md:mb-6 tracking-tight">Technical Drawings & Plans</h2>
          ...
          >
            {technicalDocuments.map((doc, index) => (
              ...
              >
                ...
                <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4 text-gray-100 group-hover:text-blue-400 transition-colors leading-tight">{doc.title}</h3>
      ...
      {/* 6. GRID LEGAL DOCUMENTS SECTION (Horizontal Scroll on Mobile) */}
      <section className="py-16 md:py-24 px-5 md:px-6 lg:px-12 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto">
          
          <div className="text-center mb-10 md:mb-16 max-w-3xl mx-auto">
            <span className="text-[#B88E52] font-semibold tracking-wider uppercase text-xs md:text-sm mb-2 md:mb-3 block">Compliance</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#0f172a] mb-4 md:mb-6">Official Legality & Licensing</h2>
            <p className="text-gray-600 text-base md:text-lg leading-relaxed">
          ...
          >
            {safetyDocuments.map((doc, index) => (
              ...
              >
                ...
                <h3 className="text-lg md:text-xl font-bold text-[#0f172a] mb-3 md:mb-4 group-hover:text-[#B88E52] transition-colors leading-tight">{doc.title}</h3>
                ...
                <div className="mt-auto pt-4 md:pt-6 border-t border-gray-100">
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 text-[#0f172a] font-bold text-xs md:text-sm hover:text-[#B88E52] transition-colors"
                  >
      ...
      <section className="py-16 md:py-24 px-5 text-center bg-white border-t border-gray-100">
        ...
        >
           ...
           <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 md:mb-6 relative z-10 leading-tight">Sail With Peace of Mind</h2>
           ...
           <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 px-6 py-4 md:px-10 md:py-5 rounded-full bg-[#B88E52] hover:bg-[#a37c46] text-white font-bold text-sm md:text-lg transition-all shadow-[0_0_20px_rgba(184,142,82,0.3)] md:shadow-[0_0_30px_rgba(184,142,82,0.4)] transform hover:scale-105 relative z-10 w-full sm:w-auto"
            >
