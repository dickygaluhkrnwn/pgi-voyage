      ...
      <section className="relative pt-28 pb-32 md:pt-40 md:pb-48 lg:pt-48 lg:pb-56 px-5 md:px-12 bg-[#0f172a] overflow-hidden flex flex-col items-center justify-center">
        ...
        >
          ...
          <motion.p variants={fadeInUp} className="text-base md:text-lg lg:text-xl text-white/80 max-w-2xl mx-auto leading-relaxed font-light px-4 md:px-0">
            Please read these terms carefully before booking your sailing adventure with PMM Voyage.
          </motion.p>
        </motion.div>
      </section>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
          ...
          >
            <div className="flex items-center gap-3 mb-6 border-b border-gray-100 pb-6">
              ...
              <h3 className="font-bold text-[#0f172a] text-lg">Table of Contents</h3>
            </div>
            ...
            <div className="prose prose-sm md:prose-base lg:prose-lg max-w-none text-gray-600">
              ...
              <div id="section-intro" className="scroll-mt-32">
                <p className="text-lg md:text-xl text-[#0f172a] mb-10 leading-relaxed font-medium">
                  Welcome to <strong className="text-[#B88E52]">PMM Voyage</strong>. We are excited to have you join us for an unforgettable sailing adventure to Komodo National Park. By booking and participating in our tour, you confirm that you have read, understood, and agreed to the following Terms & Conditions.
                </p>
              </div>
              ...
              <div className="space-y-12 md:space-y-16">
                ...
                <div id="section-1" className="scroll-mt-32">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-[#0f172a] mt-6 mb-3">Booking Process</h3>
                  <p className="mb-5 leading-relaxed">
                    Bookings can be made through our official website, direct communication with our team, or through our authorized partners. We encourage guests to book directly with PMM Voyage so our team can personally assist with booking details, trip information, special requests, and any questions before departure. A booking confirmation will be sent after your reservation and payment have been successfully received.
                  </p>

                  <h3 className="text-lg md:text-xl font-bold text-[#0f172a] mt-8 mb-3">Payment Terms</h3>
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-[#0f172a] mt-8 mb-3">Pricing</h3>
                ...
                <div id="section-2" className="scroll-mt-32">
                  ...
                  <div className="bg-[#fdfaf5] p-6 md:p-8 rounded-2xl border border-[#B88E52]/20 mb-8">
                    <h3 className="text-lg md:text-xl font-bold text-[#0f172a] mb-4 flex items-center gap-2">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-[#0f172a] mt-8 mb-3">Cancellation or Amendment by PMM Voyage</h3>
                ...
                <div id="section-3" className="scroll-mt-32">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-[#0f172a] mt-6 mb-3">Health and Fitness</h3>
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-[#0f172a] mt-6 mb-3">Travel Insurance</h3>
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-[#0f172a] mt-6 mb-3">Guest Conduct & Safety</h3>
                  <p className="mb-4 leading-relaxed">
                ...
                <div id="section-4" className="scroll-mt-32">
                  ...
                  <p className="mb-4 leading-relaxed">
                    <strong className="text-[#0f172a]">Adventure Risks & Wildlife:</strong> Guests understand that sailing trips involve natural risks (weather, sea conditions, trekking). By joining, guests participate voluntarily. Wildlife sightings (dragons, manta rays, etc.) are not guaranteed as they live freely in their natural habitat. Guests are responsible for assessing their own swimming ability.
                  </p>
                </div>
                ...
                <div id="section-5" className="scroll-mt-32">
                  ...
                  <ul className="space-y-6">
                    <li className="flex gap-4">
                      ...
                      <div>
                        <strong className="text-[#0f172a] text-lg block mb-1">Limitation of Liability</strong>
                        <span className="leading-relaxed block">PMM Voyage shall not be held responsible for injury, illness, loss, damage, or delay caused by weather, natural disasters, government regulations, third-party services, or events beyond our control. Our liability is limited to the amount paid for the tour package.</span>
                      </div>
                    </li>
                    <li className="flex gap-4">
                      ...
                      <div>
                        <strong className="text-[#0f172a] text-lg block mb-1">Personal Belongings</strong>
                    ...
                    <li className="flex gap-4">
                      ...
                      <div>
                        <strong className="text-[#0f172a] text-lg block mb-1">Environmental Responsibility</strong>
                    ...
                    <li className="flex gap-4">
                      ...
                      <div>
                        <strong className="text-[#0f172a] text-lg block mb-1">Governing Law</strong>
                ...
                <div className="bg-[#0f172a] p-8 md:p-10 lg:p-12 rounded-[1.5rem] md:rounded-[2rem] border border-[#1e293b] mt-16 text-center relative overflow-hidden shadow-2xl">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold text-white mb-3 md:mb-4 relative z-10">Final Agreement</h2>
